...
import { getProblemDetails, updateProblem } from "@/services/problem.service"
...
const ProblemDetails = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      let res = await getProblemDetails(problemId)
      res = res?.data?.data
      console.log(res)
      setFormData({
        title: res.title,
      ...
      setCodeSnippets(res.codeSnippets)
      setReferenceSolutions(res.referenceSolutions)
    }
    fetchData()
  }, [problemId])
        ...
        <div className="flex flex-1 flex-col gap-4">
          <section className="flex flex-col gap-4">
            ...
            <div>
              ...
              <Input value={formData.tags} onChange={handleTags} />
            </div>
