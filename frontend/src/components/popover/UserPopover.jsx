    ...
    >
      ...
      {isOpen && (
        <motion.div
          ...
          className="bg-secondary text-secondary border-secondary absolute top-12 right-0 flex min-h-62 min-w-64 flex-col items-start justify-between rounded-2xl border shadow-lg"
        >
          <div className="box-border w-full">
            <div className="bg-tertiary border-secondary m-1 rounded-xl border px-3 py-2">
              <p>{user?.fullName}</p>
          ...
          <div className="w-full">
            <div className="bg-border-secondary h-0.25"></div>
            <div className="flex flex-col p-2">
              <div className="hover:bg-secondary_hover flex cursor-pointer items-center gap-4 rounded-lg px-2 py-2">
              ...
              <div
                ...
                className="hover:bg-secondary_hover flex cursor-pointer items-center gap-4 rounded-lg px-2 py-2"
              >
