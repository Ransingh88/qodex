  ...
  return (
    <div className="bg-basebg-default text-fg-default relative flex h-screen w-full justify-center">
      ...
      <div className="z-1 flex h-full w-full flex-col items-center justify-start gap-6 px-24 pt-24">
        <div className="bg-basebg-default border-border-muted flex items-center gap-2 rounded-lg border px-2 py-1 tracking-wide">
        ...
        <div className="flex items-center justify-center gap-4">
          <button
            onClick={() => navigate(-1)}
            className="border-border-muted hover:bg-accent-subtle flex cursor-pointer items-center gap-2 rounded-lg border px-4 py-2 text-[#f8f8f8]"
          >
